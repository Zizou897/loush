...
class Photo(Convention):
    ...
    picture = models.FileField(
        upload_to=PICTURE_PATH, max_length=200, blank=True, null=True
    )
...
class Proprietes(Convention):
    ...
    type_propriete = models.ForeignKey(
        TypePropriete, on_delete=models.PROTECT, related_name="type_propriete_related"
    )
    ...
    localite = models.ForeignKey(
        Localite, on_delete=models.PROTECT, related_name="localite_propriete"
    )
